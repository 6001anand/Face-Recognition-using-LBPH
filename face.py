    ...
    for path, subdirnames, filenames in os.walk(directory):
        for filename in filenames:
            ...
            if test_img is None:
                ...
                continue
            faces_rect, gray_img = facedetaction(test_img)
            if len(faces_rect) != 1:
                continue
...
test_image = cv2.imread('Testimage/kangana_ranaut_1524646227.jpeg')
facedetacted, gray_img = facedetaction(test_image)
print('facedetacted', facedetacted)
